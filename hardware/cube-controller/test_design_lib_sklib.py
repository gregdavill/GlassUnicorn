...
test_design_lib = SchLib(tool=SKIDL).add_parts(*[
        Part(**{ 'name':'Conn_01x03', 'dest':TEMPLATE, 'tool':SKIDL, 'description':'Generic connector, single row, 01x03, script generated (kicad-library-utils/schlib/autogen/connector/)', 'keywords':'connector', 'F0':'J', 'F1':'Conn_01x03', 'datasheet':'~', 'ref_prefix':'J', 'num_units':1, 'fplist':['Connector*:*_1x??_*'], 'do_erc':True, 'footprint':'gkl_conn:3P_Battery_Connector', 'pins':[
        ...
        Part(**{ 'name':'R', 'dest':TEMPLATE, 'tool':SKIDL, 'description':'Resistor', 'keywords':'R res resistor', 'F0':'R', 'F1':'R', 'datasheet':'~', 'ref_prefix':'R', 'num_units':1, 'fplist':['R_*'], 'do_erc':True, 'footprint':'Resistor_SMD:R_0201_0603Metric', 'pins':[
        ...
        Part(**{ 'name':'L', 'dest':TEMPLATE, 'tool':SKIDL, 'description':'Inductor', 'keywords':'inductor choke coil reactor magnetic', 'F0':'L', 'F1':'L', 'datasheet':'~', 'ref_prefix':'L', 'num_units':1, 'fplist':['Choke_*', '*Coil*', 'Inductor_*', 'L_*'], 'do_erc':True, 'footprint':'Inductor_SMD:L_Coilcraft_XxL4020', 'pins':[
            Pin(num='1',name='1',func=Pin.types.PASSIVE,do_erc=True),
            Pin(num='2',name='2',func=Pin.types.PASSIVE,do_erc=True)] }),
        Part(**{ 'name':'C', 'dest':TEMPLATE, 'tool':SKIDL, 'description':'Unpolarized capacitor', 'keywords':'cap capacitor', 'F0':'C', 'F1':'C', 'datasheet':'~', 'ref_prefix':'C', 'num_units':1, 'fplist':['C_*'], 'do_erc':True, 'footprint':'Capacitor_SMD:C_0603_1608Metric', 'pins':[
            Pin(num='1',name='~',func=Pin.types.PASSIVE,do_erc=True),
            Pin(num='2',name='~',func=Pin.types.PASSIVE,do_erc=True)] }),
        ...
        Part(**{ 'name':'NP115-2.5', 'dest':TEMPLATE, 'tool':SKIDL, 'F0':'U', 'F3':'http://www.onsemi.com/pub/Collateral/NCP167-D.PDF', 'F1':'NCP167', 'ref_prefix':'U', 'num_units':1, 'do_erc':True, 'footprint':'gkl_housings_son:X2SON_4_1.0x1.0mm', 'pins':[
        ...
        Part(**{ 'name':'NP115-1.2', 'dest':TEMPLATE, 'tool':SKIDL, 'F0':'U', 'F3':'http://www.onsemi.com/pub/Collateral/NCP167-D.PDF', 'F1':'NCP167', 'ref_prefix':'U', 'num_units':1, 'do_erc':True, 'footprint':'gkl_housings_son:X2SON_4_1.0x1.0mm', 'pins':[
            Pin(num='1',name='OUT',func=Pin.types.INPUT,do_erc=True),
            Pin(num='2',name='GND',func=Pin.types.INPUT,do_erc=True),
            Pin(num='3',name='EN',func=Pin.types.INPUT,do_erc=True),
            Pin(num='4',name='IN',func=Pin.types.INPUT,do_erc=True)] }),
        Part(**{ 'name':'Ferrite_Bead_Small', 'dest':TEMPLATE, 'tool':SKIDL, 'description':'Ferrite bead, small symbol', 'keywords':'L ferrite bead inductor filter', 'F0':'FB', 'F1':'Ferrite_Bead_Small', 'datasheet':'~', 'ref_prefix':'FB', 'num_units':1, 'fplist':['Inductor_*', 'L_*', '*Ferrite*'], 'do_erc':True, 'footprint':'Inductor_SMD:L_0201_0603Metric', 'pins':[
            Pin(num='1',name='~',func=Pin.types.PASSIVE,do_erc=True),
            Pin(num='2',name='~',func=Pin.types.PASSIVE,do_erc=True)] }),
        Part(**{ 'name':'CP1', 'dest':TEMPLATE, 'tool':SKIDL, 'description':'Polarized capacitor, US symbol', 'keywords':'cap capacitor', 'F0':'C', 'F1':'CP1', 'datasheet':'~', 'ref_prefix':'C', 'num_units':1, 'fplist':['CP_*'], 'do_erc':True, 'footprint':'Capacitor_SMD:CP_Elec_5x3.9', 'pins':[
            Pin(num='1',name='~',func=Pin.types.PASSIVE,do_erc=True),
            Pin(num='2',name='~',func=Pin.types.PASSIVE,do_erc=True)] }),
        Part(**{ 'name':'LED_ARGB', 'dest':TEMPLATE, 'tool':SKIDL, 'description':'RGB LED, anode/red/green/blue', 'keywords':'LED RGB diode', 'F0':'D', 'F1':'LED_ARGB', 'datasheet':'~', 'ref_prefix':'D', 'num_units':1, 'fplist':['LED*', 'LED_SMD:*', 'LED_THT:*'], 'do_erc':True, 'footprint':'gkl_led:led_rbag_1515', 'pins':[
        ...
        Part(**{ 'name':'Crystal', 'dest':TEMPLATE, 'tool':SKIDL, 'description':'Two pin crystal', 'keywords':'quartz ceramic resonator oscillator', 'F0':'Y', 'F1':'Crystal', 'datasheet':'~', 'ref_prefix':'Y', 'num_units':1, 'fplist':['Crystal*'], 'do_erc':True, 'footprint':'Crystal:Crystal_SMD_2012-2Pin_2.0x1.2mm', 'pins':[
            Pin(num='1',name='1',func=Pin.types.PASSIVE,do_erc=True),
            Pin(num='2',name='2',func=Pin.types.PASSIVE,do_erc=True)] }),
        Part(**{ 'name':'ICE40UP5K-SG48ITR', 'dest':TEMPLATE, 'tool':SKIDL, 'description':'iCE40 UltraPlus FPGA, 5280 LUTs, 1.2V, 48-pin QFN', 'keywords':'FPGA programmable logic', 'F0':'U', 'F1':'ICE40UP5K-SG48ITR', 'datasheet':'http://www.latticesemi.com/Products/FPGAandCPLD/iCE40Ultra', 'F2':'Package_DFN_QFN:QFN-48-1EP_7x7mm_P0.5mm_EP5.6x5.6mm', 'ref_prefix':'U', 'num_units':4, 'fplist':['QFN*7x7mm*P0.5mm*EP5.6x5.6mm*'], 'do_erc':True, 'footprint':'Package_DFN_QFN:QFN-48-1EP_7x7mm_P0.5mm_EP5.15x5.15mm', 'pins':[
        ...
        Part(**{ 'name':'Conn_02x05_Odd_Even', 'dest':TEMPLATE, 'tool':SKIDL, 'description':'Generic connector, double row, 02x05, odd/even pin numbering scheme (row 1 odd numbers, row 2 even numbers), script generated (kicad-library-utils/schlib/autogen/connector/)', 'keywords':'connector', 'F0':'J', 'F1':'Conn_02x05_Odd_Even', 'datasheet':'~', 'ref_prefix':'J', 'num_units':1, 'fplist':['Connector*:*_2x??_*'], 'do_erc':True, 'footprint':'gkl_conn:FTSH-105-XX-X-DV', 'pins':[
            Pin(num='1',name='Pin_1',func=Pin.types.PASSIVE,do_erc=True),
        ...
        Part(**{ 'name':'AT25SF081', 'dest':TEMPLATE, 'tool':SKIDL, 'F0':'U', 'F1':'AT25SF081', 'ref_prefix':'U', 'num_units':1, 'do_erc':True, 'footprint':'gkl_housings_dfn:DFN-8-1EP_3x2mm_Pitch0.5mm', 'pins':[
        ...
        Part(**{ 'name':'SW_Push', 'dest':TEMPLATE, 'tool':SKIDL, 'description':'Push button switch, generic, two pins', 'keywords':'switch normally-open pushbutton push-button', 'F0':'SW', 'F1':'SW_Push', 'datasheet':'~', 'ref_prefix':'SW', 'num_units':1, 'do_erc':True, 'footprint':'gkl_misc:EVQP4', 'pins':[
            Pin(num='1',name='1',func=Pin.types.PASSIVE,do_erc=True),
            Pin(num='2',name='2',func=Pin.types.PASSIVE,do_erc=True)] }),
